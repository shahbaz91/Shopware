...
(function ($) {
    ...
    $.plugin('fabbricaOnePageCheckout', {
        /**
        ...
        // Prüft ob Bankdata vorhanden sind bzw. mind. eine hiervon sichtbar
        ...
        onCountryChanged: function (event) {
            ...
            $.publish('plugin/opcRegister/onCountryChangedBefore', [me, event]);
            ...
            $.publish('plugin/opcRegister/onCountryChanged', [me, event]);
        },
        ...
        onValidateInput: function (event) {
            ...
            $.publish('plugin/opcRegister/onValidateInput', [me, event, action]);
        },
        ...
        setFieldAsSuccess: function ($el) {
            ...
            $.publish('plugin/opcRegister/onSetFieldAsSuccess', [me, $el]);
        },
    ...
    $(document).ready(function () {
        $(document).fabbricaOnePageCheckout();
    })
}(jQuery));
